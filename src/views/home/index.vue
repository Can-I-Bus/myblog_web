<template>
    <div class="home_wrap">
        <div class="nav">
            ...
            <router-link class="nav_item" to="/resource">
                一些资源
            </router-link>
...
.home_wrap {
    ...
    .nav {
        ...
        .nav_item {
            font-size: 14px;
            color: #f1f0f0;
            text-shadow: 1px 0 0 rgba(0, 0, 0, 0.6), 0 0 0 rgba(0, 0, 0, 0.6),
                0 1px 0 rgba(0, 0, 0, 0.6), 0 1px 0 rgba(0, 0, 0, 0.6);
        }
    }
}
</style>